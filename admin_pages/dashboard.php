...
<body>
    ...
    <div class="container">
        <h1 class="mt-5">BOA System Admin Dashboard</h1>
        <div class="row mt-4">
            <div class="col-md-3">
                <ul class="nav flex-column nav-pills">
                    ...
                    <!--li class="nav-item">
                        <a class="nav-link" id="reporting-tab" data-toggle="pill" href="#reporting">Reporting</a>
                    </li-->
                </ul>
            </div>
            <div class="col-md-9">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="account-management">
                        ...
                        <button class="btn btn-primary" onclick="showUserProfile()">User Profile</button>
                        <button class="btn btn-primary" onclick="showAccountProfile()">Account Profile</button>
                        <button class="btn btn-primary" onclick="showFarmProfile()">Farm Profile</button>
                        <button class="btn btn-primary" onclick="showSetUserProfile()">Set User Profile</button>
                        <button class="btn btn-primary" onclick="showSearchAccountRecords()">Search Accounts</button>
                    ...
                    <div class="tab-pane fade" id="loan-management">
                        ...
                        <button class="btn btn-primary" onclick="showLoanStatus()">Approve/Reject Loan</button>
                        <button class="btn btn-primary" onclick="showDisburseLoan()">Disburse Loan</button>
                    ...
                    <div class="tab-pane fade" id="transaction-management">
                        ...
                        <button class="btn btn-primary" onclick="showSetUserProfiles()">Set User Profiles</button>
                    ...
                    <!--div class="tab-pane fade" id="reporting">
                        ...
                        <div id="reporting-content" class="mt-4"></div>
                    </div-->
                </div>
            </div>
        </div>
