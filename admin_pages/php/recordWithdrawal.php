    ...
    try {
        ...
        if ($account) {
            ...
            $stmt = $pdo->prepare('INSERT INTO Transactions (AccountID, TransactionType, Amount, Date, Status, Balance_Before, Balance_After, Description)
                                   VALUES (:accountId, "Withdrawal", :withdrawalAmount, Now(), "Completed", :balanceBefore, :balanceAfter, "Withdrawal by Admin")');
            $stmt->bindParam(':accountId', $accountId);
            $stmt->bindParam(':withdrawalAmount', $withdrawalAmount);
            ...
            $description = "Admin recorded a withdrawal of ". formatAsNaira($withdrawalAmount). " on account: $ownerAccountNo";
