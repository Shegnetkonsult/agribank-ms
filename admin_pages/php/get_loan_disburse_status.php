...
$query = $pdo->query("SELECT * FROM Users, Loans WHERE Loans.UserId = Users.UserID AND Loans.status = 'Approved'");
...
foreach ($loans as $loan) {
    ...
    $output .= '<td>
        ...
        <button class="btn btn-success disburse-loan-btn" data-loan-id="' . $loan['LoanId'] . '">Disburse</button>
    </td>';
    $output .= '</tr>';
}
